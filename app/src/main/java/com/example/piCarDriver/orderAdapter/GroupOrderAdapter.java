...
public class GroupOrderAdapter extends RecyclerView.Adapter<GroupOrderAdapter.ViewHolder> {
        private List<List<GroupOrder>> orders;
        private Driver driver;

    public GroupOrderAdapter(List<List<GroupOrder>> orders, Driver driver) {
            this.orders = orders;
            this.driver = driver;
        }
        ...
        public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int i) {
            List<GroupOrder> order = orders.get(viewHolder.getAdapterPosition());
